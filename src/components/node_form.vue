<template>
  ...
  <el-collapse-item title="基础配置" name="1">
    <div class="label-wrap">
      ...
      <el-input size="medium" v-model="node.name"></el-input>
    </div>
    <div class="label-wrap" v-if="node.nodeData">
      <div class="label-name">关联词槽</div>
     <el-select size="medium" v-model="node.nodeData.slot" placeholder="请选择" clearable style="width:100%;">
    <el-option
  ...
  <el-collapse-item title="跳转关系" name="2">
    <div class="label-wrap">
